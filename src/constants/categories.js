...
export const LEVEL_ORDER = ['Law', 'Constitutional Law'];
export const CATEGORY_LIST = [...LEVEL_ORDER];

export const CATEGORY_COLORS = {
  Law:                 { bg: INK.panel, accent: INK.gold, pill: `${INK.gold}22`, line: INK.hairlineStrong },
  'Constitutional Law': { bg: INK.panel, accent: '#c99a3a', pill: '#c99a3a22', line: '#382f1c' },
  Custom:              { bg: INK.panel, accent: '#b89a5a', pill: '#b89a5a22', line: '#332c1e' },
};
export const CATEGORY_EMOJI = { Law: '⚖︎', 'Constitutional Law': '🔨', Custom: '✦' };
